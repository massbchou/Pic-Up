...
function Home() {
    ...
    return (
        <div className="container-fluid text-center bg-body-secondary border-bottom border-black" id="container-header">
            ...
            <div class="col-3 pt-1 text-start" id="logo"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-controller" viewBox="0 0 16 16">
